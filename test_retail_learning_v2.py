#!/usr/bin/env python3
"""Headless test: retail learning WITHOUT compositional mode."""
...
# Inline the fixed learning manager
...
print("=" * 60)
print("Test: WITH retail primitives, NO compositional mode")
print("=" * 60)
...
config.max_free_energy_for_promotion = 100.0  # very lenient for demo

repertoire = ScriptRepertoire(library, config=config, initial_patterns=fragments)
# NO enable_compositional_mode() — Tier 2 is skipped
...
print("\n" + "=" * 60)
if crystallized:
    print("SUCCESS: Pattern crystallized from retail primitives!")
else:
    print("No crystallization in 10 loops.")
print("=" * 60)
